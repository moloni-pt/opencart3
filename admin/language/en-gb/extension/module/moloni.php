...
$_['error_permission'] = 'Warning: You do not have permission to access Moloni!';
$_['text_success'] = 'Success: You have modified module Moloni!';

$_['login_text'] = 'Login with your moloni credentials';
...
$_['tooltip']['import_products'] = "All products from your Moloni account will be imported";
$_['tooltip']['import_tax_class'] = "Choose the tax class to be applied to the imported products";
$_['tooltip']['import_product_since'] = "Choose the date from which all products will be imported. By default, all products that were created/modified in the last 7 days will be imported";
...
$_['tooltip']['replace_white_space'] = "Replace all white spaces with an underscore in product's reference";
...
$_['label']['tools'] = "Tools";
$_['label']['none'] = "None";
$_['label']['import_product_since'] = "Import products since";
...
$_['label']['import_products'] = "Import products";
$_['label']['update_import_products'] = "Update products";
$_['label']['update_import_products_name'] = "Title";
$_['label']['update_import_products_stock'] = "Stock";
$_['label']['update_import_products_price'] = "Price";
$_['label']['update_import_products_image'] = "Image";
$_['label']['import_tax_class'] = "Tax class of imported products";
...
$_['label']['replace_white_space'] = "Replace space with underscore";
...
$_['label']['order_table_body_wait'] = "Please wait, fetching data";
